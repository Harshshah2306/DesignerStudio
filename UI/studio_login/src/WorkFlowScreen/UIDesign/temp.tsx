...
export default function DesignerScreenUtility(props: {
    ...
    React.useEffect(() => {
        if (selectedStep !== null && myState.elements[allSteps[selectedStep].id]) {
    ...
    const [{ isOver }, drop] = useDrop({
        ...
        // drop: (item:{id:string, text:string},monitor: DropTargetMonitor)=>{
                ...
                <Grid item md={9}>
                    ...
                    >
                        <Grid container alignItems="center" direction="column" justifyContent="center">
                            ...
                            <Grid item md={12}>
                                <Typography variant="h4" gutterBottom>
                                    Step: {selectedStep !== null ? allSteps[selectedStep].name : 'N/A'}
                                </Typography>
                            </Grid>
